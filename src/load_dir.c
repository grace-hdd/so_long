...
t_list	*ft_load_north(t_game *g, char *path, int i)
{
	...
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_semi_up.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_open_up.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_semi_up.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_closed.xpm", &i, &i)));
	return (anim);
}
t_list	*ft_load_south(t_game *g, char *path, int i)
{
	...
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_semi_down.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_open_down.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_semi_down.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_closed.xpm", &i, &i)));
...
t_list	*ft_load_east(t_game *g, char *path, int i)
{
	...
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_semi_right.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_open_right.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_semi_right.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_closed.xpm", &i, &i)));
...
t_list	*ft_load_west(t_game *g, char *path, int i)
{
	...
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_semi_left.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_open_left.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_semi_left.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Pac-Man/pac_closed.xpm", &i, &i)));
...
t_list	*ft_load_panic(t_game *g, int i)
{
	...
	anim = NULL;
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Ghosts/Panic/ghost_panic1a.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Ghosts/Panic/ghost_panic1b.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Ghosts/Panic/ghost_panic2a.xpm", &i, &i)));
	ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(g->id, \
		"textures/Ghosts/Panic/ghost_panic2b.xpm", &i, &i)));
	return (anim);
}
